      ...
      <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
        ...
        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0 gap-8">
          ...
          <div v-if="!userStore.user" class="flex gap-8 justify-content-center items-center">
            <NuxtLink to="/login" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900"> Sign
              in
            </NuxtLink>
            <NuxtLink to="/register" class="whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-gray-800 bg-yellow-200 hover:bg-yellow-300">
              Sign up
            </NuxtLink>
          </div>
